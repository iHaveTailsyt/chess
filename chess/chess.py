            ...
            while x>0:
                if(x==8):
                    if(chr(i)=='a' or chr(i)=='h'):
                        self.piece_location[chr(i)][x][0] = "black rook"
                    elif(chr(i)=='b' or chr(i)=='g'):
                        self.piece_location[chr(i)][x][0] = "black knight"
                    elif(chr(i)=='c' or chr(i)=='f'):
                        self.piece_location[chr(i)][x][0] = "black bishop"
                    elif(chr(i)=='d'):
                        self.piece_location[chr(i)][x][0] = "black queen"
                    elif(chr(i)=='e'):
                        self.piece_location[chr(i)][x][0] = "black king"
                elif(x==7):
                    self.piece_location[chr(i)][x][0] = "black pawn"
                elif(x==2):
                    self.piece_location[chr(i)][x][0] = "white pawn"
                elif(x==1):
                    if(chr(i)=='a' or chr(i)=='h'):
                        self.piece_location[chr(i)][x][0] = "white rook"
                    elif(chr(i)=='b' or chr(i)=='g'):
                        self.piece_location[chr(i)][x][0] = "white knight"
                    elif(chr(i)=='c' or chr(i)=='f'):
                        self.piece_location[chr(i)][x][0] = "white bishop"
                    elif(chr(i)=='d'):
                        self.piece_location[chr(i)][x][0] = "white queen"
                    elif(chr(i)=='e'):
                        self.piece_location[chr(i)][x][0] = "white king"
                x = x - 1
