...
class Game:
    ...
    def menu(self):
        ...
        created_by = small_font.render("Created by inferno", True, black_color)
        aka = small_font.render("Aka Tails", True , black_color)
        ...
        self.screen.blit(aka,
                         ((self.screen.get_width() - aka.get_width()) // 2,
                          self.screen.get_height() - aka.get_height() - 50))
